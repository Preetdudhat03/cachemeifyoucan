  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 800, margin: "0 auto" }}>
        ...
        <h1 style={{ fontSize: "clamp(2.8rem, 9vw, 5.5rem)", fontWeight: 200, lineHeight: 1.05, letterSpacing: "-0.03em", marginBottom: "1.5rem" }}>
        ...
        <p style={{ color: "var(--text-muted)", fontSize: "1.1rem", maxWidth: 520, margin: "0 auto 2.5rem", lineHeight: 1.8 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "0.5rem", flexWrap: "wrap" }}>
          {["Next.js", "FastAPI", "scikit-learn", "Plotly", "Pandas", "SciPy"].map((t, i) => (
            <span key={t}>
              <span className="stack-tag">{t}</span>
              {i < 5 && <span className="stack-divider">·</span>}
            </span>
          ))}
        </div>
      </div>
